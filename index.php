                            ...
                            <div class="modal-body">
                                ...
                                <form id="commentForm" action="admin/index-get-comment/process_comment.php" method="POST">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="nameInput" name="name" value="<?=getPostVal('name');?>">
                                    </div>
                                    <div class="mb-3">
                                        <label for="commentInput" class="form-label">Комментарий</label>
                                        <textarea class="form-control" id="commentInput" name="comment" rows="3"><?= getPostVal('comment'); ?></textarea>
                                    </div>
    ...
    <div class="container mb-5 p-3">
        <div class="text-center mb-5">
            ...
            <div class="d-flex flex-column justify-content-center align-items-center text-center">
                ...
                <div class="w-50">
                    <input type="email" id="emailField" placeholder="Введите email" class="form-control mb-2"
                           aria-label="Email для подписки">
                    <button onclick="checkEmail()" class="btn btn-dark w-100">Подписаться на тьму</button>
                </div>
            </div>
        </div>
